...
const Sidebar = () => {
    return (
        <div className="bg-gray-50 sticky mt-10  h-screen  fixed-top   overflow-x-scroll-scroll ">
            <div className=" mb-5 ">
                <div className=" w-52  md:w-64 ">
                    <div className="flex h-100 flex-grow flex-col overflow-y-auto   bg-gray-50 pt-5 ">
